            ...
            <div class="px-8 pt-7 pb-2">
                ...
                @if($colocation->members->isEmpty())
                    <div class="flex flex-col items-center justify-center py-8 text-center">
                        ...
                        <p class="text-sm text-zinc-500">No members yet. Invite someone below.</p>
                    </div>
                @else
                            ...
                            <li class="flex items-center justify-between py-3.5 group">
                                ...
                                @php
                                    ...
                                    $badgeClass = match($status) {
                                        ...
                                        'inactive' => 'bg-zinc-700/40 text-zinc-500 border-zinc-700',
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full bg-zinc-800/60 border border-zinc-700 text-zinc-100 placeholder-zinc-500
                                       ...
                                       @error('email') border-red-500/60 focus:ring-red-500/40 @enderror"
                            >
                        </div>
